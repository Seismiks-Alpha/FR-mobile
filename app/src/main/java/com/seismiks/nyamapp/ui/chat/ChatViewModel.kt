...
class ChatViewModel(private val remoteRepository: RemoteRepository) : ViewModel() {
    ...
    fun sendMessageGemini(token: String, userId: String, questionText: String) {
        ...
        viewModelScope.launch {
            val repoLiveData = remoteRepository.postQuestionGemini(token, userId, questionText)
    ...
    fun sendMessageLocal(token: String, userId: String, questionText: String) {
        ...
        viewModelScope.launch {
            val repoLiveData = remoteRepository.postQuestionLocal(token, userId, questionText)
            currentRepoResponseLiveData = repoLiveData

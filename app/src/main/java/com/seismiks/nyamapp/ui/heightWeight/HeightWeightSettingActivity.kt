...
import com.seismiks.nyamapp.databinding.ActivityHeightWeightSettingBinding
import com.seismiks.nyamapp.ui.home.HomeActivity
import kotlinx.coroutines.launch

class HeightWeightSettingActivity : AppCompatActivity() {
    private lateinit var binding: ActivityHeightWeightSettingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHeightWeightSettingBinding.inflate(layoutInflater)
                    ...
                    currentUser?.getIdToken(true)?.addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            if (idToken != null) {
                                putProfile(idToken)
                                val intent = Intent(
                                    this@HeightWeightSettingActivity,
        ...
        viewModel.updateProfileUpdateAndStatus(token, profileUser).observe(this) { result ->
            when (result) {
                ...
                is Result.Success -> {
                    ...
                    val intent = Intent(this@HeightWeightSettingActivity, HomeActivity::class.java)
                    startActivity(intent)
                    finish()
                }
